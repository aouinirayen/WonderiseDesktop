...
public class NavBarBackController {
    ...
    @FXML
    public void handleGuideButton(ActionEvent event) throws IOException {
        loadScene("Guide/Guide.fxml", event);
    }

    @FXML
    public void handleEvenementButton(ActionEvent event) throws IOException {
        loadScene("Evenement/Evenement.fxml", event);
    }
